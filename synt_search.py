...
SERPAPI_API_KEY = os.environ['SERPAPI_API_KEY'] = '8561c4fa81ea2fe2fe4bc23e8a85a9e684f177ecfe7f6fb6f460d9f68c1cbe84'
...
text = generate("Be an IPL Cricket Reporter of the most recent match")
print(text)
